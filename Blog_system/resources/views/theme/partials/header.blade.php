@php
    $headerCategores =\App\Models\Category::get();
//    $headerCategores =\App\Models\Category::take(2)->get();
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav justify-content-center">
                        ...
                        <li class="nav-item submenu dropdown @yield('categories-active')">
                            ...
                            @if(count($headerCategores) > 0)
                            <ul class="dropdown-menu">
                                @foreach($headerCategores as $category)
                    ...
                    @if(!Auth::check())
                        ...
                        <ul class="nav navbar-nav navbar-right navbar-social">
                            <a href="{{route('register')}}" class="btn btn-sm mx-2 btn-warning">Register</a>
                        </ul>
                    @else
                        <ul class="nav navbar-nav navbar-right navbar-social">
